...
|     x | RUTGERS vs. PENN ST                  | Spread          |              +20.5 | 2%  | ok down to 20     |
|     x | SMU vs. MEMPHIS                      | Spread          |    -8.5 (ok to 10) | 2%  |                   |
|     x | TULANE vs. FAU                       | Spread          |      -9 (ok to 10) | 2%  |                   |
|     x | ARIZONA vs. UTAH                     | Moneyline       |  -115 (ok to -125) | 2%  |                   |
|     x | AIR FORCE vs. UNLV                   | Spread          |       -2 (ok to 3) | 2%  |                   |
|     x | NCST vs. VAT                         | Spread          |     +2.5 (ok to 2) | 2%  |                   |
|     x | LOUISIANA vs. TROY                   | Spread          | +16.5 (ok to 14.5) | 2%  |                   |
|     x | NEW MEXICO ST. vs. AUBURN            | Spread          |   +25.5 (ok to 24) | 2%  |                   |
|     x | UCF vs. TEXAS TECH                   | Spread          |     +2.5 (ok to 2) | 2%  |                   |
|     x | S. ALABAMA vs. MARSHALL              | Spread          |     -10 (ok to 13) | 2%  |                   |
|     x | UTAH ST. vs. BOISE                   | Spread          |     +4.5 (ok to 3) | 2%  |                   |
|     x | WISCONSIN vs. NEBRASKA               | Spread          |     -5.5 (ok to 7) | 2%  |                   |
|     x | SYRACUSE vs. GATECH                  | 1st Half Spread |     +3.5 (ok to 3) | 2%  |                   |
...
|     x | LOUISIANA vs. TROY                   | Moneyline       |  +500 (ok to +400) | 1%  |                   |
|     x | SYRACUSE vs. GA TECH                 | Moneyline       |  +200 (ok to +190) | 1%  |                   |
|     x | IOWA STATE vs. TEXAS                 | Moneyline       |  +235 (ok to +200) | 1%  |                   |
...
| Done? | Game                           | Bet Type   | Spread/Line | Max | Notes                 |
| ----: | ------------------------------ | ---------- | ----------: | --- | --------------------- |
|     x | RAVENS -3.5 BENGALS            | Spread     |        -3.5 | 2%  | ok to 4               |
...
|     x | TITANS +7 JAGS                 | Spread     |          +7 | 2%  | ok at 7 or higher     |
|     x | PACKERS +3 CHARGERS            | Spread     |          +3 | 2%  | ok at 3 or higher     |
